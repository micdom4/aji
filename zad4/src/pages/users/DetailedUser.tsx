...
export default function DetailedUser() {
    ...
    const columns: Column<AllocationType>[] = useMemo(() => [
        ...
        },
        {
            ...
            render: (a) => <span className="text-secondary">#{a._id}</span>
        },
        {
            header: 'Start Time',
            ...
            try {
                ...
                if (fetchedUser.type.toString() === "CLIENT") {
                    const [pastRes, activeRes] = await Promise.all([
                        allocationApi.getPastForClient(fetchedUser._id),
                        allocationApi.getActiveForClient(fetchedUser._id)
                    ]);
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8">
                            <ListGroup variant="flush">
                                <ListGroup.Item>
                                    <strong>ID:</strong> <span className="text-muted">{user._id}</span>
                                </ListGroup.Item>
                                <ListGroup.Item>
